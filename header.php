...
<head>
  ...
  <link type="text/css" rel="stylesheet"
    href="<?php echo esc_url(get_template_directory_uri()); ?>/js/slick/slick-theme.css">
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NKLKRLZ6" height="0" width="0"
    ...
    <div class="inner">
        ...
        <a href="<?php echo esc_url(home_url('/')); ?>">
          <picture>
            ...
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/logo.png"
              alt="歯医者なら箕面市のヨクシオ歯科箕面萱野" loading="lazy" decoding="async" fetchpriority="high">
          </picture>
        </a>
      </h1>
      <nav class="header-nav">
          ...
          <li class="header-nav__menu-item has-sub <?php if (is_page('about') || is_page('sterilization')): echo 'active';
            ...
            <div class="header-nav__submenu">
              <ul class="header-nav__submenu-list center">
                ...
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>treatment-policy">治療方針</a></li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>sterilization">減菌体制</a></li>
              </ul>
            </div>
          </li>
          <li class="header-nav__menu-item has-sub <?php if (is_page('medical') || is_page('general') || is_page('periodontal') || is_page('preventive') || is_page('pediatric') || is_page('pediatric-ortho') || is_page('orthodontics') || is_page('ceramic') || is_page('implant') || is_page('denture') || is_page('visit')): echo 'active';
            ...
            <div class="header-nav__submenu">
              <ul class="header-nav__submenu-list">
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>general">一般歯科</a>
                </li>
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>root-canal">根管治療</a>
                </li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>periodontal">歯周病治療</a></li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>preventive">予防・メンテナンス</a></li>
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>pediatric">小児歯科</a>
                </li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>pediatric-ortho">小児矯正</a></li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>orthodontics">成人矯正</a></li>
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>ceramic">セラミック・審美治療</a></li>
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>implant">インプラント</a>
                </li>
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>denture">入れ歯（義歯）</a>
                </li>
                <!-- <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>visit">訪問診療</a></li> -->
                <li class="header-nav__submenu-item"><a
                    href="<?php echo esc_url(home_url('/')); ?>maternity">マタニティ歯科</a></li>
                <!-- <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>botox">歯科でボトックス治療</a>
                </li> -->
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>tmd">顎関節症の治療</a></li>
                <li class="header-nav__submenu-item"><a href="<?php echo esc_url(home_url('/')); ?>bruxism">歯ぎしり・<br
                      class="pc-xl">食いしばりの治療</a></li>
              </ul>
            </div>
          </li>
        ...
        <a href="https://reservation.stransa.co.jp/47f4f9361243ec0de8a3020288b7d279" target="_blank"
          class="header-nav__web">
          <span><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/common/icon-fixed.png"
              alt="WEB予約"></span> WEB予約
        </a>
      </nav>
